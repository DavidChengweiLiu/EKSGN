...
class UGCN(nn.Module):
    ...
    def forward(self, adj, gcn_inputs):
        ...
        x_var = var_vectors.mul(node_weight)
        ...
        x_var = hid_output_var.mul(node_weight)
        Ax_mean = adj.bmm(x_mean)
        Ax_var = adj_var.bmm(x_var)
...
class GCN_Joint_EFP(nn.Module):
    def __init__(self, config, y_num):
        ...
        self.bert = BertModel.from_pretrained('bert-base-uncased')   # bert-base-uncased for english data, bert-base-chinese for chinese data
