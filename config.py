...
def parse_args():
    ...
    parser.add_argument('--saved_path', type=str, default='../data/english_uncertain_plain_gcn_joint_doc.pkl', help='path to the saved_data file')
    ...
    parser.add_argument('--model_path', type=str, default="./checkpoint/enlish_model")
